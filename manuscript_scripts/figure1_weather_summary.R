...
precipitation_panel2 <- ggplot(
  ...
  # Manual in-panel irrigation key
  annotate(
    "point",
    x = as.Date("2022-07-04"),
    y = 25,
    shape = 25,
    size = 2.5,
    fill = "black",
...
# Step: Precipitation + Supplemental water drop irrigation panel (not used)-----
...
precipitation_panel_combined <- precipitation_panel2 +
  labs(x = "Date")
...
##if I want to remove the starting measurement date, comment out "geom_vline"
